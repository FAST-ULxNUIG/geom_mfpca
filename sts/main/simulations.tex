...
\begin{figure*}
     \centering
    \includegraphics[scale=0.6]{figures/scenario_1/computation_time.eps}
...
\begin{figure*}
     \centering
    \includegraphics[scale=0.6]{figures/scenario_2/computation_time.eps}
...
\begin{figure*}
    \centering
    \includegraphics[scale=0.45]{figures/scenario_1/logAE.eps}
...
\begin{figure*}
     \centering
    \includegraphics[scale=0.7]{figures/scenario_2/logAE.eps}
...
\begin{figure*}
     \centering
    \includegraphics[scale=0.45]{figures/scenario_1/ise.eps}
...
\begin{figure*}
     \centering
    \includegraphics[scale=0.7]{figures/scenario_2/ise.eps}
...
\begin{figure*}
     \centering
     \includegraphics[scale=0.6]{figures/scenario_1/mise.eps}
...
\begin{figure*}
     \centering
     \includegraphics[scale=0.6]{figures/scenario_2/mise.eps}
