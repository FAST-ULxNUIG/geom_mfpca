...
do
    ...
    python ./code/main.py -nsimu 200 -nobs $N -npoints 11 11 21 -noise 0 -percentages 0.5 0.5  -k 12 ./results
done
...
do
    ...
    python ./code/main.py -nsimu 200 -nobs $N -npoints 26 26 51 -noise 0 -percentages 0.5 0.5  -k 12 ./results
done
