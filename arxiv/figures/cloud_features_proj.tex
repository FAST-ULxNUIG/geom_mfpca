...
\draw (1, 0) node[above, scale=0.4] {$\sqrt{\pi_l}\langle\!\langle X_l - \mu, \mu \rangle\!\rangle$};

\draw (-0.5, -0.5) node[scale=0.3] {$\bullet$};
\draw (-0.5, -0.5) node[left, scale=0.4] {$\sqrt{\pi_m}\langle\!\langle X_m - \mu, \mu \rangle\!\rangle$};


\draw (-0.25, -0.25) node[scale=0.3] {$\bullet$};
\draw (-0.25, -0.25) node[above left, scale=0.4] {$\sqrt{\pi_m}\langle\!\langle X_m - \mu, f \rangle\!\rangle$};

\draw (0, 1.25) node[scale=0.3] {$\bullet$};
\draw (0, 1.25) node[above right, scale=0.4] {$\sqrt{\pi_n}\langle\!\langle X_n - \mu, f \rangle\!\rangle$};
