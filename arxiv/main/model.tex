...
\end{equation}
\textcolor{red}{Correction for the diagonal.}

\textcolor{red}{Following \cite{benkoCommonFunctionalPrincipal2009,grithFunctionalPrincipalComponent2018},}
\begin{equation}
    \textcolor{red}{\widehat{\mathbf{M}}_{nn^\prime} = \sqrt{\pi_n \pi_{n^{\prime}}}\sum_{p = 1}^P \int_{\TT{p}}\{\hatXnp(t_p) - \widehat{\mu}^{(p)}(t_p)\}\{\widehat{X}^{(p)}_{n^\prime}(t_p) - \widehat{\mu}^{(p)}(t_p)\} \dd t_p, \quad n, n^\prime = 1, \dots, N.}
\end{equation}
\textcolor{red}{Correction for the diagonal.}
