...
\add{Using the expansion of the data into the basis of function $\Psi$, the inner-product matrix $M$ is written 
\begin{align}
    M &= \left(\mathrm{I}_{\!N} - \mathbf{1}_{\!N}\Pi^\top\right) C W C^\top \left(\mathrm{I}_{\!N} - \Pi\mathbf{1}_{\!N}^\top\right) \\
      &= \left[\left(\mathrm{I}_{\!N} - \mathbf{1}_{\!N}\Pi^\top\right)CW^{1/2}\right]\left[\left(\mathrm{I}_{\!N} - \mathbf{1}_{\!N}\Pi^\top\right)CW^{1/2}\right]^\top,
\end{align}
