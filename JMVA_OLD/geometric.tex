...
\begin{figure}
    \centering
    \includegraphics[scale=1.2]{duality_diagram}
...
\begin{figure}
    \centering
    \includegraphics[scale=1.2]{cloud_obs}
    \includegraphics[scale=1.2]{cloud_obs_proj}
...
\begin{figure}
    \centering
    \includegraphics[scale=1.2]{cloud_features}
    \includegraphics[scale=1.2]{cloud_features_proj}
